...
description: When verifying that a process follows all required steps before completion or handoff.
...
**Adopted by:** Aviation (FAA), surgery (WHO), NASA, nuclear power (NRC).
**Impact:** WHO Surgical Safety Checklist reduced surgical complications by 36% and deaths
by 47% (Haynes et al., NEJM 2009).
